...
> *Предполагается, что у Вас есть понноценный аккаунт в Yandex*
Пару лет назад я писал нечто подобное в Yandex Cloud, но на Питоне. <br>
Так же использовались Serverless Functions, Yandex Data Base, триггеры, очереди и ещё IoT (Internet of Things)<br>
Но для питона больше библиотек и куча примеров в сети, так что не составило большого труда разобраться.<br>
С библиотеками под Golang не всё так просто - пратически с каждой функцией по взаимодействию с ресурсами Облака пришлось немало и погуглить, и повозиться.<br>
Будем считать, что я попытался подготовить готовый рецепт, который можно скомпиллировать, а затем менять сообразно своим замыслам.<br>
Замечу, что и функций, и ресурсов тарраформа гораздо больше параметров, чем использовал я.<br>
Но проще же добавлять/менять в работающем коде, читая документацию, а её в Yandex Cloud очень много<br>

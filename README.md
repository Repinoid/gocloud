...
С библиотеками под Golang не всё так просто - пратически с каждой функцией по взаимодействию с ресурсами Облака пришлось немало и погуглить, и повозиться.
...
Замечу, что и функций, и ресурсов тарраформа гораздо больше параметров, чем использовал я.

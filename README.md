...
Функция считывает сообщение из Очереди, декодирует и пищет в Базу данных<hr>
По HTTP юзер делает запросы, которые поступают в API Gateway, который запускает функции работы с БД в соответствии с форматом HTTP-запроса<br>
